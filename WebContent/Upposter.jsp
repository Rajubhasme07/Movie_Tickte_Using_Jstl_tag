                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="element.html" class="dropdown-item">Other Elements</a>
                             <a href="addmove.jsp" class="dropdown-item">ADD MOVIES</a>
                         <a href="shmoves.jsp" class="dropdown-item">SHOW MOVIES</a>
                        </div>
                    </div>
            ...
            <!-- Form Start -->
                   ...
                   <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="addmovieimg.jsp">
                            
                                <div class="row mb-3">
                                <input type="hidden" value="${mname}">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Movies Poster</label>
                                    <div class="col-sm-10">
